...
class RegressionDetectionLogicTest {
    ...
    void testResponseTimeRegression() {
        ...
        // Test with significantly worse response time (50% increase, above 20%
        // threshold)
        PerformanceBaseline currentBaseline = new PerformanceBaseline(
        ...
        assertTrue(result.getRegressionSeverity().ordinal() > PerformanceRegressionResult.RegressionSeverity.NONE
                .ordinal());
        assertTrue(result.getRegressionDetails().stream()
    ...
    void testCustomRegressionThresholds() {
        ...
        PerformanceRegressionResult.RegressionThresholds customThresholds = new PerformanceRegressionResult.RegressionThresholds(
                50.0, 30.0, 10.0);
    ...
    void testRegressionSeverityClassification() {
        ...
        assertTrue(majorResult.getRegressionSeverity().ordinal() >= PerformanceRegressionResult.RegressionSeverity.MAJOR
                .ordinal());
    }
