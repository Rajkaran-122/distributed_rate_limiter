...
import com.Rajkaran_122.distributedratelimiter.models.ComplianceZone;
...
class GeographicConfigurationResolverTest {
    ...
    void testPriorityBasedRuleResolution() {
        ...
        GeographicRateLimitConfig highPriorityRule = new GeographicRateLimitConfig("high-priority", "api:*", "US",
                highPriorityLimits);
        ...
        GeographicRateLimitConfig lowPriorityRule = new GeographicRateLimitConfig("low-priority", "api:*", "US",
                lowPriorityLimits);
    ...
    void testComplianceZoneBasedRule() {
        ...
        GeographicRateLimitConfig gdprRule = new GeographicRateLimitConfig("gdpr-rule", "api:*", "EU",
                ComplianceZone.GDPR, gdprLimits, 100);
