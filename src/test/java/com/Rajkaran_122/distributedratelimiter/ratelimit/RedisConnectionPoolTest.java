...
class RedisConnectionPoolTest {
    ...
    void testConnectionPoolPerformance() throws InterruptedException {
                ...
                try {
                    for (int j = 0; j < operationsPerThread; j++) {
                        try (var connection = connectionFactory.getConnection()) {
                            ...
                            // Log the error but don't fail immediately - let test complete and assess
                            // overall success
        ...
        // Check that most operations succeeded (allow some failures in CI/CD
        // environments)
        ...
        // Reduced operations should complete in under 10 seconds (more generous for
        // CI/CD)
