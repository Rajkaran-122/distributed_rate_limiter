...
class MemoryUsageTest {
    ...
    void testBucketCleanupReducesMemoryUsage() throws InterruptedException {
        ...
        // Wait for cleanup to occur (buckets should expire after 500ms + cleanup
        // interval of 1000ms)
    ...
    void testMemoryLeakPrevention() throws InterruptedException {
        ...
        while (System.currentTimeMillis() < endTime) {
            ...
            RateLimitConfig config = new RateLimitConfig(10, 5, 100, RateLimitAlgorithm.TOKEN_BUCKET); // Expire after
                                                                                                       // 100ms
            backend.getRateLimiter(key, config);
