...
/**
 * Tests comparing burst handling behavior between TokenBucket and SlidingWindow
 * algorithms.
 */
public class BurstHandlingComparisonTest {
    ...
    void test_recoveryAfterBurst() {
        ...
        // Wait for recovery - token bucket refills gradually, sliding window resets
        // after window
        Awaitility.await()
    ...
    void test_burstyVsSteadyTrafficPatterns() throws InterruptedException {
        ...
        // TokenBucket allows gradual recovery, SlidingWindow has stricter window
        // enforcement
    ...
    void test_algorithmSelectionInService() {
        ...
        // The specific behavioral differences would be tested in longer integration
        // tests
    }
}