...
/**
 * Tests for the enhanced RateLimiterService with configurable limits per
 * key/pattern.
 */
public class ConfigurableRateLimiterServiceTest {
    ...
    void test_shouldPreferExactKeyOverPattern() {
        ...
        assertFalse(rateLimiterService.isAllowed(specialKey, 1),
                "Special API key should reject when capacity exceeded");
        ...
        assertFalse(rateLimiterService.isAllowed(regularApiKey, 1),
                "Regular API key should reject when capacity exceeded");
    }
