...
class CompositeRateLimiterServiceTest {
    ...
    void shouldHandleCompositeConfigurationWithMultipleLimits() {
        ...
        CompositeRateLimitConfig.LimitDefinition apiCallsLimit = new CompositeRateLimitConfig.LimitDefinition(
                "api_calls", RateLimitAlgorithm.TOKEN_BUCKET, "API", 100, 10, 1.0, 1, null);

        CompositeRateLimitConfig.LimitDefinition bandwidthLimit = new CompositeRateLimitConfig.LimitDefinition(
    ...
    void shouldCreateCombinationResultWithCorrectLogic() {
        CompositeRateLimitConfig.LimitDefinition limitDef = new CompositeRateLimitConfig.LimitDefinition(
    ...
    void shouldHandleHierarchicalLimitsWithDifferentScopes() {
        CompositeRateLimitConfig.LimitDefinition userLimit = new CompositeRateLimitConfig.LimitDefinition(
                "user_limit", RateLimitAlgorithm.TOKEN_BUCKET, "USER", 10, 2, 1.0, 1, null);

        CompositeRateLimitConfig.LimitDefinition tenantLimit = new CompositeRateLimitConfig.LimitDefinition(
    ...
    void shouldIdentifyLimitingComponentWhenRateLimited() {
        ...
        CompositeRateLimitConfig.LimitDefinition restrictiveLimit = new CompositeRateLimitConfig.LimitDefinition(
                "restrictive", RateLimitAlgorithm.TOKEN_BUCKET, null, 1, 1, 1.0, 1, null // Very low capacity
        );

        CompositeRateLimitConfig.LimitDefinition permissiveLimit = new CompositeRateLimitConfig.LimitDefinition(
