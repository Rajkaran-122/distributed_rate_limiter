...
public class RateLimitControllerTest {
    ...
    static class TestConfig {
        ...
        @Bean
        public com.Rajkaran_122.distributedratelimiter.ratelimit.CompositeRateLimiterService compositeRateLimiterService() {
            return mock(com.Rajkaran_122.distributedratelimiter.ratelimit.CompositeRateLimiterService.class);
        }
        ...
        @Bean
        public com.Rajkaran_122.distributedratelimiter.geo.GeographicRateLimitService geographicRateLimitService() {
            return mock(com.Rajkaran_122.distributedratelimiter.geo.GeographicRateLimitService.class);
        }

        @Bean
        public com.Rajkaran_122.distributedratelimiter.adaptive.AdaptiveRateLimitEngine adaptiveRateLimitEngine() {
            return mock(com.Rajkaran_122.distributedratelimiter.adaptive.AdaptiveRateLimitEngine.class);
        }
    }
