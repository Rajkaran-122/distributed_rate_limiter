...
class AdaptiveRateLimitControllerTest {
    ...
    void testGetAdaptiveStatus_Success() {
        ...
        AdaptiveRateLimitEngine.AdaptiveStatusInfo mockStatus = new AdaptiveRateLimitEngine.AdaptiveStatusInfo(
                "ADAPTIVE",
                0.85,
                100,
                10,
    ...
    void testOverrideAdaptation_Success() {
        // Arrange
        String key = "test:key";
        AdaptiveRateLimitController.AdaptationOverrideRequest request = new AdaptiveRateLimitController.AdaptationOverrideRequest(
                200, 20, "Test override");
    ...
    void testGetAdaptiveConfig_Success() {
        // Act
        ResponseEntity<AdaptiveRateLimitController.AdaptiveConfigResponse> response = controller.getAdaptiveConfig();
