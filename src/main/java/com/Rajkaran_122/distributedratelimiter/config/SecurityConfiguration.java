...
public class SecurityConfiguration {
    ...
    public ApiKeys getApiKeys() {
        return apiKeys; // Note: ApiKeys class already implements defensive copying in its own
                        // getters/setters
    }
    ...
    public Ip getIp() {
        return ip; // Note: Ip class already implements defensive copying in its own
                   // getters/setters
    }
