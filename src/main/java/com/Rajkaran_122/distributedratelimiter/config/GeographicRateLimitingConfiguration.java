 ...
 * Provides conditional beans that are only created when geographic rate
 * limiting is enabled.
 */
@Configuration
public class GeographicRateLimitingConfiguration {
    ...
    /**
     * Create GeographicRateLimitService bean only when geographic rate limiting is
     * enabled.
    ...
    public GeographicRateLimitService geographicRateLimitService(
            com.Rajkaran_122.distributedratelimiter.geo.GeoLocationService geoLocationService,
            com.Rajkaran_122.distributedratelimiter.geo.GeographicConfigurationResolver geographicConfigResolver,
            com.Rajkaran_122.distributedratelimiter.ratelimit.RateLimiterService rateLimiterService,
            com.Rajkaran_122.distributedratelimiter.ratelimit.ConfigurationResolver standardConfigResolver,
    ...
    public GeographicAwareConfigurationResolver geographicAwareConfigurationResolver(
            com.Rajkaran_122.distributedratelimiter.ratelimit.RateLimiterConfiguration configuration,
            com.Rajkaran_122.distributedratelimiter.geo.GeographicConfigurationResolver geographicConfigResolver) {
    ...
    /**
     * Create a no-op GeographicRateLimitService when geographic rate limiting is
     * disabled.
    ...
    /**
     * No-op implementation of GeographicRateLimitService for when geographic rate
    ...
    static class NoOpGeographicRateLimitService extends GeographicRateLimitService {
        ...
        @Override
        public com.Rajkaran_122.distributedratelimiter.models.GeographicRateLimitResponse checkGeographicRateLimit(
            ...
            return new com.Rajkaran_122.distributedratelimiter.models.GeographicRateLimitResponse(
                    key, tokens, true, null, "geographic-disabled", null, "GEOGRAPHIC_RATE_LIMITING_DISABLED");
        }

        @Override
        public com.Rajkaran_122.distributedratelimiter.models.GeographicRateLimitResponse checkGeographicRateLimit(
                com.Rajkaran_122.distributedratelimiter.models.RateLimitRequest request, String sourceIP,
                java.util.Map<String, String> headers) {
            return checkGeographicRateLimit(request.getKey(), sourceIP, request.getTokens(), headers);
        }

        @Override
        public com.Rajkaran_122.distributedratelimiter.models.GeoLocation detectLocation(String sourceIP,
                java.util.Map<String, String> headers) {
            return null;
        }

        @Override
        public boolean hasGeographicRules(com.Rajkaran_122.distributedratelimiter.models.GeoLocation geoLocation) {
            return false;
        }
