...
import com.Rajkaran_122.distributedratelimiter.models.ConfigurationResponse;
import com.Rajkaran_122.distributedratelimiter.models.ConfigurationStats;
import com.Rajkaran_122.distributedratelimiter.models.DefaultConfigRequest;
...
public class RateLimitConfigController {
     ...
     */
    @GetMapping
    @Operation(summary = "Get current rate limiter configuration", description = "Retrieves the current configuration including default settings, per-key configurations, and patterns")
    @ApiResponse(responseCode = "200", description = "Current configuration retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ConfigurationResponse.class)))
