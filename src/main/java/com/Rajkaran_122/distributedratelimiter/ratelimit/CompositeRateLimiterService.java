...
import com.Rajkaran_122.distributedratelimiter.models.CompositeRateLimitResponse.ComponentResult;
import com.Rajkaran_122.distributedratelimiter.models.CompositeRateLimitResponse.CombinationResult;
    ...
    private CombinationResult createCombinationResult(CombinationLogic logic,
        ...
        switch (logic) {
            ...
            case PRIORITY_BASED:
                ...
                componentResults.forEach((name, result) -> componentScores.put(name, result.isAllowed() ? 1.0 : 0.0));
                break;
