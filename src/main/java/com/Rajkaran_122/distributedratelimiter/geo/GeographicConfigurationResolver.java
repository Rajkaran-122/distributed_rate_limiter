...
/**
 * Resolves geographic rate limit configurations based on location and key
 * patterns.
...
public class GeographicConfigurationResolver {
    ...
    // In-memory storage for geographic rules (in production, this could be
    // externalized)
     ...
     * Returns null if no geographic rule applies (fallback to standard
     * configuration).
     */
    public RateLimitConfig resolveGeographicConfig(String key, GeoLocation geoLocation) {
        ...
        if (cached != null) {
            logger.debug("Geographic configuration found in cache for key: {} location: {}", key,
    ...
    public void initializeDefaultRules() {
        ...
        // Note: In a real implementation, these would come from application.properties
        // or database
