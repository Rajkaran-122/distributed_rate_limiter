...
/**
 * Geographic-aware configuration resolver that extends the standard
 * ConfigurationResolver.
 * Handles geographic rate limit configurations with fallback to standard
 * configurations.
 */
@Service
...
public class GeographicAwareConfigurationResolver extends ConfigurationResolver {
     ...
     * This should be called before resolving configuration for geographic rate
     * limiting.
     */
