 ...
 * Supports CloudFlare, AWS CloudFront, Azure CDN, and other popular CDN
 * providers.
 */
@Component
...
public class CDNHeaderParser {
    ...
    public GeoLocation parseAzureHeaders(Map<String, String> headers) {
        // Azure CDN doesn't provide direct country headers, but we can try common
        // patterns
    ...
    /**
     * Parse generic geographic headers that might be set by load balancers or
     * proxies.
