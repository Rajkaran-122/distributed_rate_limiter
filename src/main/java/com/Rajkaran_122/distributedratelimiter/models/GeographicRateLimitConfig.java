 ...
 * Defines rate limits that apply to specific geographic regions, countries, or
 * compliance zones.
 */
public class GeographicRateLimitConfig {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, keyPattern, countryCode, region, complianceZone, limits, priority, validFrom,
                validUntil, enabled);
    }
